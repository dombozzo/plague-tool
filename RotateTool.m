...
% Last Modified by GUIDE v2.5 14-Apr-2017 17:57:28
...
% --- Executes on selection change in mapselectionPopUp.
function mapselectionPopUp_Callback(hObject, eventdata, handles)
% hObject    handle to mapselectionPopUp (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns mapselectionPopUp contents as cell array
%        contents{get(hObject,'Value')} returns selected item from mapselectionPopUp
sphereRotateF(handles);


% --- Executes during object creation, after setting all properties.
function mapselectionPopUp_CreateFcn(hObject, eventdata, handles)
% hObject    handle to mapselectionPopUp (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
